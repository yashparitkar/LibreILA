...
#define CORE_LIBRE_ILA_STRIDE_WIDTH (CORE_LIBRE_ILA_DATA_WIDTH/32 + 1)
#warning "CORE_LIBRE_ILA_STRIDE_WIDTH is not defined, using default value of (CORE_LIBRE_ILA_DATA_WIDTH/32 + 1)."
#endif
...
#define CORE_LIBRE_ILA_SAMP_FREQ_HZ 1000000000u
...
#define CORE_LIBRE_ILA_N_IP_REGS 4 + CORE_LIBRE_ILA_DATA_WIDTH/32 * 2
#define CORE_LIBRE_ILA_N_OP_REGS 8 + CORE_LIBRE_ILA_STRIDE_WIDTH * CORE_LIBRE_ILA_SAMP_BUFF_DEPTH

#define CORE_LIBRE_ILA_N_CTRL_REGS CORE_LIBRE_ILA_N_IP_REGS + CORE_LIBRE_ILA_N_OP_REGS

#define CORE_LIBRE_ILA_OP_REGS_OFFSET CORE_LIBRE_ILA_N_IP_REGS * 4
 ...
 */
#define CORE_LIBRE_ILA_REGS_TRIG_COND_REG_OFFSET       0x00U
#define CORE_LIBRE_ILA_REGS_TRIG_COND_REG_LENGTH       0x04U
...
#define CORE_LIBRE_ILA_REGS_TRIG_COND_REG_TREADY_FIELD_OFFSET     \
                (CORE_LIBRE_ILA_REGS_TRIG_COND_REG_OFFSET)
#define CORE_LIBRE_ILA_REGS_TRIG_COND_REG_TREADY_FIELD_SHIFT      (0U)
#define CORE_LIBRE_ILA_REGS_TRIG_COND_REG_TREADY_FIELD_NS_MASK    ((uint32_t)(0x00000001UL))
#define CORE_LIBRE_ILA_REGS_TRIG_COND_REG_TREADY_FIELD_MASK \
      (CORE_LIBRE_ILA_REGS_TRIG_COND_REG_TREADY_FIELD_NS_MASK << \
         CORE_LIBRE_ILA_REGS_TRIG_COND_REG_TREADY_FIELD_SHIFT)
...
#define CORE_LIBRE_ILA_REGS_TRIG_COND_REG_TVALID_FIELD_OFFSET     \
                (CORE_LIBRE_ILA_REGS_TRIG_COND_REG_OFFSET)
#define CORE_LIBRE_ILA_REGS_TRIG_COND_REG_TVALID_FIELD_SHIFT      (1U)
#define CORE_LIBRE_ILA_REGS_TRIG_COND_REG_TVALID_FIELD_NS_MASK    ((uint32_t)(0x00000001UL))
#define CORE_LIBRE_ILA_REGS_TRIG_COND_REG_TVALID_FIELD_MASK \
      (CORE_LIBRE_ILA_REGS_TRIG_COND_REG_TVALID_FIELD_NS_MASK << \
         CORE_LIBRE_ILA_REGS_TRIG_COND_REG_TVALID_FIELD_SHIFT)
...
#define CORE_LIBRE_ILA_REGS_TRIG_COND_REG_TLAST_FIELD_OFFSET     \
                (CORE_LIBRE_ILA_REGS_TRIG_COND_REG_OFFSET)
#define CORE_LIBRE_ILA_REGS_TRIG_COND_REG_TLAST_FIELD_SHIFT      (2U)
#define CORE_LIBRE_ILA_REGS_TRIG_COND_REG_TLAST_FIELD_NS_MASK    ((uint32_t)(0x00000001UL))
#define CORE_LIBRE_ILA_REGS_TRIG_COND_REG_TLAST_FIELD_MASK \
      (CORE_LIBRE_ILA_REGS_TRIG_COND_REG_TLAST_FIELD_NS_MASK << \
         CORE_LIBRE_ILA_REGS_TRIG_COND_REG_TLAST_FIELD_SHIFT)
...
#define CORE_LIBRE_ILA_REGS_TRIG_COND_REG_TDATA_FIELD_OFFSET     \
                (CORE_LIBRE_ILA_REGS_TRIG_COND_REG_OFFSET)
#define CORE_LIBRE_ILA_REGS_TRIG_COND_REG_TDATA_FIELD_SHIFT      (3U)
#define CORE_LIBRE_ILA_REGS_TRIG_COND_REG_TDATA_FIELD_NS_MASK    ((uint32_t)(0x00000001UL))
#define CORE_LIBRE_ILA_REGS_TRIG_COND_REG_TDATA_FIELD_MASK \
      (CORE_LIBRE_ILA_REGS_TRIG_COND_REG_TDATA_FIELD_NS_MASK << \
         CORE_LIBRE_ILA_REGS_TRIG_COND_REG_TDATA_FIELD_SHIFT)
...
#define CORE_LIBRE_ILA_REGS_TRIG_COND_REG_ANDOR_FIELD_OFFSET     \
                (CORE_LIBRE_ILA_REGS_TRIG_COND_REG_OFFSET)
#define CORE_LIBRE_ILA_REGS_TRIG_COND_REG_ANDOR_FIELD_SHIFT      (4U)
#define CORE_LIBRE_ILA_REGS_TRIG_COND_REG_ANDOR_FIELD_NS_MASK    ((uint32_t)(0x00000001UL))
#define CORE_LIBRE_ILA_REGS_TRIG_COND_REG_ANDOR_FIELD_MASK \
      (CORE_LIBRE_ILA_REGS_TRIG_COND_REG_ANDOR_FIELD_NS_MASK << \
         CORE_LIBRE_ILA_REGS_TRIG_COND_REG_ANDOR_FIELD_SHIFT)
 ...
 * Description: This register is used to configure the trigger condition for the ILA. It allows the user to set specific conditions that will trigger the ILA to start capturing data.
 */
#define CORE_LIBRE_ILA_REGS_TRIG_MASK_REG_OFFSET       0x04U
#define CORE_LIBRE_ILA_REGS_TRIG_MASK_REG_LENGTH       0x04U
...
#define CORE_LIBRE_ILA_REGS_TRIG_MASK_REG_TREADY_FIELD_OFFSET     \
                (CORE_LIBRE_ILA_REGS_TRIG_MASK_REG_OFFSET)
#define CORE_LIBRE_ILA_REGS_TRIG_MASK_REG_TREADY_FIELD_SHIFT      (0U)
#define CORE_LIBRE_ILA_REGS_TRIG_MASK_REG_TREADY_FIELD_NS_MASK    ((uint32_t)(0x00000001UL))
#define CORE_LIBRE_ILA_REGS_TRIG_MASK_REG_TREADY_FIELD_MASK \
      (CORE_LIBRE_ILA_REGS_TRIG_MASK_REG_TREADY_FIELD_NS_MASK << \
         CORE_LIBRE_ILA_REGS_TRIG_MASK_REG_TREADY_FIELD_SHIFT)
...
#define CORE_LIBRE_ILA_REGS_TRIG_MASK_REG_TVALID_FIELD_OFFSET     \
                (CORE_LIBRE_ILA_REGS_TRIG_MASK_REG_OFFSET)
#define CORE_LIBRE_ILA_REGS_TRIG_MASK_REG_TVALID_FIELD_SHIFT      (1U)
#define CORE_LIBRE_ILA_REGS_TRIG_MASK_REG_TVALID_FIELD_NS_MASK    ((uint32_t)(0x00000001UL))
#define CORE_LIBRE_ILA_REGS_TRIG_MASK_REG_TVALID_FIELD_MASK \
      (CORE_LIBRE_ILA_REGS_TRIG_MASK_REG_TVALID_FIELD_NS_MASK << \
         CORE_LIBRE_ILA_REGS_TRIG_MASK_REG_TVALID_FIELD_SHIFT)
...
#define CORE_LIBRE_ILA_REGS_TRIG_MASK_REG_TLAST_FIELD_OFFSET     \
                (CORE_LIBRE_ILA_REGS_TRIG_MASK_REG_OFFSET)
#define CORE_LIBRE_ILA_REGS_TRIG_MASK_REG_TLAST_FIELD_SHIFT      (2U)
#define CORE_LIBRE_ILA_REGS_TRIG_MASK_REG_TLAST_FIELD_NS_MASK    ((uint32_t)(0x00000001UL))
#define CORE_LIBRE_ILA_REGS_TRIG_MASK_REG_TLAST_FIELD_MASK \
      (CORE_LIBRE_ILA_REGS_TRIG_MASK_REG_TLAST_FIELD_NS_MASK << \
         CORE_LIBRE_ILA_REGS_TRIG_MASK_REG_TLAST_FIELD_SHIFT)
...
#define CORE_LIBRE_ILA_REGS_TRIG_MASK_REG_TDATA_FIELD_OFFSET     \
                (CORE_LIBRE_ILA_REGS_TRIG_MASK_REG_OFFSET)
#define CORE_LIBRE_ILA_REGS_TRIG_MASK_REG_TDATA_FIELD_SHIFT      (3U)
#define CORE_LIBRE_ILA_REGS_TRIG_MASK_REG_TDATA_FIELD_NS_MASK    ((uint32_t)(0x00000001UL))
#define CORE_LIBRE_ILA_REGS_TRIG_MASK_REG_TDATA_FIELD_MASK \
      (CORE_LIBRE_ILA_REGS_TRIG_MASK_REG_TDATA_FIELD_NS_MASK << \
         CORE_LIBRE_ILA_REGS_TRIG_MASK_REG_TDATA_FIELD_SHIFT)
 ...
 */
#define CORE_LIBRE_ILA_REGS_ARM_FT_REG_OFFSET       0x0CU
 ...
 *
 * Description: This register is used to configure the trigger condition for the ILA. It allows the user to set specific conditions that will trigger the ILA to start capturing data. Total CORE_LIBRE_ILA_DATA_WIDTH/32 registers are used to configure the trigger condition for the ILA. It allows the user to set specific conditions that will trigger the ILA to start capturing data.
 */
#define CORE_LIBRE_ILA_REGS_TRIG_DATA_COND_LSB_REG_OFFSET       0x10U
#define CORE_LIBRE_ILA_REGS_TRIG_DATA_COND_LSB_REG_LENGTH       0x04U
#define CORE_LIBRE_ILA_REGS_TRIG_DATA_COND_LSB_REG_RW_MASK      0xFFFFFFFFU
#define CORE_LIBRE_ILA_REGS_TRIG_DATA_COND_LSB_REG_RO_MASK      0x00000000U
#define CORE_LIBRE_ILA_REGS_TRIG_DATA_COND_LSB_REG_WO_MASK      0x00000000U
#define CORE_LIBRE_ILA_REGS_TRIG_DATA_COND_LSB_REG_READ_MASK    0xFFFFFFFFU
#define CORE_LIBRE_ILA_REGS_TRIG_DATA_COND_LSB_REG_WRITE_MASK   0xFFFFFFFFU

/*******************************************************************************
 * Register: TRIG_DATA_MASK_LSB_REG
 *
 * Description: This register is used to configure the trigger condition mask for the ILA. It allows the user to set specific conditions that will trigger the ILA to start capturing data. Total CORE_LIBRE_ILA_DATA_WIDTH/32 registers are used to configure the trigger condition for the ILA. It allows the user to set specific conditions that will trigger the ILA to start capturing data.
 */
#define CORE_LIBRE_ILA_REGS_TRIG_DATA_MASK_LSB_REG_OFFSET       0x10U + CORE_LIBRE_ILA_DATA_WIDTH/32 * 4
#define CORE_LIBRE_ILA_REGS_TRIG_DATA_MASK_LSB_REG_LENGTH       0x04U
#define CORE_LIBRE_ILA_REGS_TRIG_DATA_MASK_LSB_REG_RW_MASK      0xFFFFFFFFU
#define CORE_LIBRE_ILA_REGS_TRIG_DATA_MASK_LSB_REG_RO_MASK      0x00000000U
#define CORE_LIBRE_ILA_REGS_TRIG_DATA_MASK_LSB_REG_WO_MASK      0x00000000U
#define CORE_LIBRE_ILA_REGS_TRIG_DATA_MASK_LSB_REG_READ_MASK    0xFFFFFFFFU
#define CORE_LIBRE_ILA_REGS_TRIG_DATA_MASK_LSB_REG_WRITE_MASK   0xFFFFFFFFU
...
#define CORE_LIBRE_ILA_REGS_STATUS_REG_RW_MASK      0xFFFFFFFFU
#define CORE_LIBRE_ILA_REGS_STATUS_REG_RO_MASK      0x00000000U
#define CORE_LIBRE_ILA_REGS_STATUS_REG_WO_MASK      0x00000000U
#define CORE_LIBRE_ILA_REGS_STATUS_REG_READ_MASK    0xFFFFFFFFU
#define CORE_LIBRE_ILA_REGS_STATUS_REG_WRITE_MASK   0xFFFFFFFFU
...
#define CORE_LIBRE_ILA_REGS_STATUS_REG_STATUS_FIELD_OFFSET     \
                (CORE_LIBRE_ILA_REGS_STATUS_REG_OFFSET)
#define CORE_LIBRE_ILA_REGS_STATUS_REG_STATUS_FIELD_SHIFT      (3U)
#define CORE_LIBRE_ILA_REGS_STATUS_REG_STATUS_FIELD_NS_MASK    ((uint32_t)(0x00000002UL))
#define CORE_LIBRE_ILA_REGS_STATUS_REG_STATUS_FIELD_MASK \
      (CORE_LIBRE_ILA_REGS_STATUS_REG_STATUS_FIELD_NS_MASK << \
         CORE_LIBRE_ILA_REGS_STATUS_REG_STATUS_FIELD_SHIFT)
 ...
 */
#define CORE_LIBRE_ILA_REGS_DEPTH_REG_OFFSET       0xF0U + CORE_LIBRE_ILA_OP_REGS_OFFSET
 ...
 */
#define CORE_LIBRE_ILA_REGS_SAMP_BUFF_TRIG_IDX_REG_OFFSET       0xF8U + CORE_LIBRE_ILA_OP_REGS_OFFSET
...
#define CORE_LIBRE_ILA_REGS_SAMP_BUFF_TRIG_IDX_REG_BUFF_DEPTH_FIELD_OFFSET     \
                (CORE_LIBRE_ILA_REGS_SAMP_BUFF_TRIG_IDX_REG_OFFSET)
#define CORE_LIBRE_ILA_REGS_SAMP_BUFF_TRIG_IDX_REG_BUFF_DEPTH_FIELD_SHIFT      (0U)
#define CORE_LIBRE_ILA_REGS_SAMP_BUFF_TRIG_IDX_REG_BUFF_DEPTH_FIELD_NS_MASK    ((uint32_t)(0xFFFFFFFFUL))
#define CORE_LIBRE_ILA_REGS_SAMP_BUFF_TRIG_IDX_REG_BUFF_DEPTH_FIELD_MASK \
      (CORE_LIBRE_ILA_REGS_SAMP_BUFF_TRIG_IDX_REG_BUFF_DEPTH_FIELD_NS_MASK << \
         CORE_LIBRE_ILA_REGS_SAMP_BUFF_TRIG_IDX_REG_BUFF_DEPTH_FIELD_SHIFT)
 ...
 * Description: This register stores the index of the sample buffer where the trigger event occurred.
 */
#define CORE_LIBRE_ILA_REGS_SAMP_BUFF_FRST_IDX_REG_OFFSET       0xFCU + CORE_LIBRE_ILA_OP_REGS_OFFSET
...
#define CORE_LIBRE_ILA_REGS_SAMP_BUFF_FRST_IDX_REG_BUFF_DEPTH_FIELD_OFFSET     \
                (CORE_LIBRE_ILA_REGS_SAMP_BUFF_FRST_IDX_REG_OFFSET)
#define CORE_LIBRE_ILA_REGS_SAMP_BUFF_FRST_IDX_REG_BUFF_DEPTH_FIELD_SHIFT      (0U)
#define CORE_LIBRE_ILA_REGS_SAMP_BUFF_FRST_IDX_REG_BUFF_DEPTH_FIELD_NS_MASK    ((uint32_t)(0xFFFFFFFFUL))
#define CORE_LIBRE_ILA_REGS_SAMP_BUFF_FRST_IDX_REG_BUFF_DEPTH_FIELD_MASK \
      (CORE_LIBRE_ILA_REGS_SAMP_BUFF_FRST_IDX_REG_BUFF_DEPTH_FIELD_NS_MASK << \
         CORE_LIBRE_ILA_REGS_SAMP_BUFF_FRST_IDX_REG_BUFF_DEPTH_FIELD_SHIFT)
 ...
 */
#define CORE_LIBRE_ILA_REGS_SAMP_BUFF_BASE_REG_OFFSET       0x00U + CORE_LIBRE_ILA_N_CTRL_REGS * 4
