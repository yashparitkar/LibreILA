...
module caxi4interconnect_AHB_SM_Undefburst (
   ...
   always  @(ph_cnt or ahb_write_op or latched_exp_burst_len or cycle_in_progress or int_masterRDATA_hold or haddr_latched or hsize_latched or valid_data_avail or zero_strb or count_match or
             int_masterWREADY or check_end or wrcnt or wrerr or new_cycle or INITIATOR_HWRITE or int_masterAWREADY or exp_burst_len or INITIATOR_HADDR or INITIATOR_HSIZE or int_masterARREADY or
             int_masterRVALID or check_all or end_cycle or int_masterRDATA or int_masterRRESP or wrcntmax or BUSY or int_masterBVALID or int_masterBRESP or visual_AHB_SM_current or INITIATOR_HRDATA_reg or int_masterBREADY_reg)
   begin : AHB_SM_comb
      ...
      case (visual_AHB_SM_current)
         AXI_EXTEND:
            begin
               INITIATOR_HRDATA = int_masterRDATA_hold;
               if (ahb_write_op)
               begin
                  int_masterWVALID = 1;
               ...
               begin
                  ...
                  begin
                     ...
                     begin
                        ...
                        begin
                           int_masterRREADY = 1;
                           INITIATOR_HRDATA = int_masterRDATA;
                           visual_int_masterRDATA_hold_next = int_masterRDATA;
                           INITIATOR_HRESP = int_masterRRESP[1];
                           visual_ph_cnt_next = ph_cnt + 1;
   ...
   always
      @( posedge ACLK or negedge iarst_sync )
   begin   :bresp_cnt
   ...
   begin   :ph_plus_1_gen
      ...
      begin
         ph_cnt_plus_1 <= (visual_ph_cnt_next + 1'b1);
           ...
           // Write Data Channel
           assign int_masterWDATA = INITIATOR_HWDATA;
           assign int_masterWUSER = 'b0;
 
           // Write Address Channel
		   generate
		   if(ADDR_WIDTH > 'd32) begin
		       assign int_masterAWADDR = {{(ADDR_WIDTH-32){1'b0}}, INITIATOR_HADDR};
		   end else begin
		       assign int_masterAWADDR = INITIATOR_HADDR[ADDR_WIDTH-1:0];  
		   end
           endgenerate 
           assign int_masterAWSIZE = INITIATOR_HSIZE;
           assign int_masterAWID = 'b0;
           assign int_masterAWQOS = 'b0;
           assign int_masterAWREGION = 'b0;
           assign int_masterAWUSER = 'b0;
           assign int_masterAWCACHE = {INITIATOR_HPROT[5], INITIATOR_HPROT[5], INITIATOR_HPROT[3], INITIATOR_HPROT[2]};
           assign int_masterAWLOCK = { 1'b0, INITIATOR_HMASTLOCK};
           assign int_masterAWLEN = exp_burst_len;
           assign int_masterAWBURST = ((INITIATOR_HBURST[2:1] == 2'b00) || (INITIATOR_HBURST[0] == 1'b1)) ? 2'h1 : 2'h2;
           assign int_masterAWPROT = {~INITIATOR_HPROT[0], INITIATOR_HNONSEC, INITIATOR_HPROT[1]};
 
           // Read Address Channel
		   generate
		   if(ADDR_WIDTH > 'd32) begin
		       assign int_masterARADDR = {{(ADDR_WIDTH-32){1'b0}}, INITIATOR_HADDR};
		   end else begin
		       assign int_masterARADDR = INITIATOR_HADDR[ADDR_WIDTH-1:0];  
		   end
           endgenerate 
		   

           assign int_masterARSIZE = INITIATOR_HSIZE;
           assign int_masterARID = 'b0;
           assign int_masterARQOS = 'b0;
           assign int_masterARREGION = 'b0;
           assign int_masterARUSER = 'b0;
           assign int_masterARCACHE = {INITIATOR_HPROT[5], INITIATOR_HPROT[5], INITIATOR_HPROT[3], INITIATOR_HPROT[2]};
           assign int_masterARLOCK = { 1'b0, INITIATOR_HMASTLOCK};
           assign int_masterARLEN = exp_burst_len;
           assign int_masterARBURST = ((INITIATOR_HBURST[2:1] == 2'b00) || (INITIATOR_HBURST[0] == 1'b1)) ? 2'h1 : 2'h2;
           assign int_masterARPROT = {~INITIATOR_HPROT[0], INITIATOR_HNONSEC, INITIATOR_HPROT[1]};
	...
	assign axi_len_limit      = (1<<12) - int_masterAWADDR[11:0]; 
